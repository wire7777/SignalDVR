...
data class Recording(
    ...
    @SerializedName("processing_percent") val processingPercent: Int = 0,
    @SerializedName("processing_step") val processingStep: String? = null,
    @SerializedName("processing_error") val processingError: String? = null,
    @SerializedName("vod_ready") val vodReady: Int = 0,
    @SerializedName("processed_at") val processedAt: String? = null,
    @SerializedName("guide_metadata_json") val guideMetadataJson: String? = null,
)
